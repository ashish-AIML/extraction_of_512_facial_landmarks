...
def get_model(ctx, image_size, model_str, layer):
  ...
  #model.bind(data_shapes=[('data', (loder.batch_size, 3, image_size[0], image_size[1]))], label_shapes=[('softmax_label', (loder.batch_size,))])
...
class FaceModel:
  ...
  def get_input(self, face_img):
    ...
    if face_img is None:
      print("face_image empty handled")
      return []
    ...
    bboxes, points = ret
    results = []
    for bbox, points1 in zip(bboxes, points):
        bbox = bbox[0:4]
        points1 = points1.reshape((2,5)).T
        # print(bbox)
        # print(points1)
        nimg = face_preprocess.preprocess(face_img, bbox, points1, image_size='112,112')
